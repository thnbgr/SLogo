...
public class Node {
    ...
    /**
     * constructor for the Node class. Initializes myChildren 
     * ArrayList
     */
    public Node() {
     ...
     * @param child - a child Node which will be added to the 
     ...
     * @param numArgs - the int value of the number of arguments 
     * (number of children)
     * this node will take
     */
    ...
    /**
     * empty class that will be overwritten by subclasses which 
     * sets the value of the node that will be returned. 
     */
    ...
    /**
     * This method calls the evaluate function for all of this node's 
     * children and also calls the setReturnValue method that will be 
    ...
    /**
     * This method is a recursive implementation of making a syntax tree based 
     * on the number of arguments this node requires
