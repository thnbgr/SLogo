...
public class Workspace {
	...
	// private HashMap<Integer, TurtleData> mySTH = new HashMap<Integer,
	// TurtleData>();
	// COMMENT: would this be better? the View will pass us this HashMap and the
	// workspace ID
	// - what Jimmy was talking about passing a collection of data
	// Integer is the turtle ID, TurtleData is a package that contains the part
	// of the turtle that we can change
	// the list of booleans for viewCommands we were talking about can also be
	// included.
	// and updaing would also be easier? we can just update the values of
	// TurtleData.
	...
	// some classes (other than Turtle, or Strategy would be pointless) to
	// implement it
	...
	/**
	 * 1. ifelsenode needs debugging 2. parentheses for sum, need generics to
	 * get all thingies 3. workspace into model check values of turtle 4. decode
	 * into nodes.
	 * 
	 */
	...
	public void save() {
		// save to a resource bundle the necessary information required to
	...
	public void update(String s, ArrayList<Turtle> turtleList) { // update to
																	// specific
																	// turtles
